...
var About = () => /* @__PURE__ */ jsx5("section", { id: "about", className: "about", children: /* @__PURE__ */ jsx5("div", { className: "container", children: /* @__PURE__ */ jsx5("div", { className: "about-content", children: /* @__PURE__ */ jsxs4("div", { className: "about-text", children: [
  ...
  /* @__PURE__ */ jsxs4("div", { className: "credentials", children: [
    /* @__PURE__ */ jsxs4("div", { className: "education", children: [
      /* @__PURE__ */ jsx5("h3", { children: "Education" }),
      /* @__PURE__ */ jsx5("p", { children: "Bachelor of Science in Biochemistry And Cellular And Molecular Biology" }),
      /* @__PURE__ */ jsx5("p", { children: "University of Tennessee, Knoxville, TN" })
    ] }),
    /* @__PURE__ */ jsxs4("div", { className: "awards", children: [
      /* @__PURE__ */ jsx5("h3", { children: "Recognition" }),
      /* @__PURE__ */ jsx5("p", { children: "Encore Award - For exceptional contribution to a high-impact, time-sensitive project" }),
      /* @__PURE__ */ jsx5("p", { children: "Pendo Partner Certification - Software management platform expertise" })
    ] })
  ] })
] }) }) }) });
...
var MessageBubble = ({ message }) => {
  ...
  return /* @__PURE__ */ jsx6("div", { className: `flex ${isUser ? "justify-end" : "justify-start"}`, children: /* @__PURE__ */ jsxs5("div", { className: `max-w-[80%] ${isUser ? "bg-[var(--rweir-brand)] text-white" : "bg-white text-gray-800"} rounded-2xl px-4 py-2 shadow-sm`, children: [
    /* @__PURE__ */ jsx6("p", { className: "text-sm whitespace-pre-wrap", children: message.content }),
    message.sources && message.sources.length > 0 && /* @__PURE__ */ jsx6(SourcesList, { sources: message.sources }),
    message.tokens != null && message.cost != null && /* @__PURE__ */ jsxs5("p", { className: "text-xs text-gray-500 mt-1", children: [
      message.tokens,
      " tokens \xB7 $",
...
var SourcesList = ({ sources }) => /* @__PURE__ */ jsxs5("details", { className: "mt-2 pt-2 border-t border-gray-200", children: [
  ...
  /* @__PURE__ */ jsx6("div", { className: "mt-2 space-y-1", children: sources.map((source, i) => /* @__PURE__ */ jsxs5("div", { className: "text-xs bg-gray-50 p-2 rounded", children: [
    /* @__PURE__ */ jsx6("p", { className: "font-medium text-gray-700", children: source.source }),
    /* @__PURE__ */ jsx6("p", { className: "text-gray-600 mt-1", children: source.content }),
...
var ChatInput = ({ value, onChange, onSend, isLoading }) => /* @__PURE__ */ jsx6("div", { className: "p-4 bg-white border-t border-gray-200", children: /* @__PURE__ */ jsxs5("div", { className: "flex gap-2", children: [
  /* @__PURE__ */ jsx6(
    "input",
    {
      type: "text",
  ...
  /* @__PURE__ */ jsx6(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx6("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx6("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 19l9 2-9-18-9 18 9-2zm0 0v-8" }) })
    }
  )
] }) });
var ChatbotWidget = () => {
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "fixed bottom-8 md:right-8 z-50", children: [
    !isOpen && /* @__PURE__ */ jsx6("div", { className: "fixed bottom-8 right-8", children: /* @__PURE__ */ jsxs5("button", { onClick: () => {
      setIsOpen(true);
    ...
    isOpen && /* @__PURE__ */ jsxs5("div", { className: "bg-white rounded-2xl shadow-2xl w-96 max-w-[calc(100vw-2rem)] h-[600px] max-h-[calc(100vh-2rem)] flex flex-col overflow-hidden border border-gray-200", children: [
      /* @__PURE__ */ jsx6(ChatHeader, { onClose: () => setIsOpen(false) }),
      /* @__PURE__ */ jsxs5("div", { className: "flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50", children: [
        messages.length === 0 && /* @__PURE__ */ jsx6("div", { className: "text-center text-gray-500 mt-8", children: /* @__PURE__ */ jsx6("p", { className: "text-sm", children: "Ask me anything about my background, research, or interests!" }) }),
        messages.map((msg, idx) => /* @__PURE__ */ jsx6(MessageBubble, { message: msg }, idx)),
        isLoading && /* @__PURE__ */ jsx6("div", { className: "flex justify-start", children: /* @__PURE__ */ jsx6("div", { className: "bg-white rounded-2xl px-4 py-3 shadow-sm", children: /* @__PURE__ */ jsxs5("div", { className: "flex gap-1", children: [
          /* @__PURE__ */ jsx6("div", { className: "w-2 h-2 bg-gray-400 rounded-full animate-bounce" }),
          /* @__PURE__ */ jsx6("div", { className: "w-2 h-2 bg-gray-400 rounded-full animate-bounce", style: { animationDelay: "0.1s" } }),
          /* @__PURE__ */ jsx6("div", { className: "w-2 h-2 bg-gray-400 rounded-full animate-bounce", style: { animationDelay: "0.2s" } })
        ] }) }) }),
        error && /* @__PURE__ */ jsx6("div", { className: "bg-red-50 border border-red-200 rounded-lg p-3 text-sm text-red-800", children: error }),
        /* @__PURE__ */ jsx6("div", { ref: messagesEndRef })
      ] }),
      /* @__PURE__ */ jsx6(ChatInput, { value: input, onChange: setInput, onSend: handleSend, isLoading })
    ] })
  ] });
};
...
var ProjectCard = ({ category }) => /* @__PURE__ */ jsxs7("div", { className: "showcase-card flex flex-1 flex-col sm:flex-row gap-4", children: [
  /* @__PURE__ */ jsx8("img", { src: `images/${category.icon}`, className: "h-24 w-24 object-contain sm:mx-0 sm:h-20 sm:w-auto" }),
  /* @__PURE__ */ jsxs7("div", { children: [
    /* @__PURE__ */ jsx8("h3", { className: "project-title", children: category.title }),
...
var ScreenshotCarousel = () => {
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "mt-10 md:mt-0 shrink-0 flex flex-col items-center gap-5", children: [
    /* @__PURE__ */ jsx9("div", { className: "w-56 h-[480px] shrink-0", children: /* @__PURE__ */ jsx9(
      "img",
      {
  ...
  /* @__PURE__ */ jsxs9("div", { className: "current-role-card", children: [
    /* @__PURE__ */ jsxs9("div", { className: "current-role-header", children: [
      /* @__PURE__ */ jsxs9("div", { children: [
        ...
        /* @__PURE__ */ jsx10("span", { className: "current-role-meta", children: "Agile 6" })
      ] }),
      /* @__PURE__ */ jsx10("div", { className: "exp-period", children: "2025\u2013Present" })
    ] }),
    /* @__PURE__ */ jsxs9("p", { className: "current-role-body", children: [
...
root.render(/* @__PURE__ */ jsx12(App_default, {}));
